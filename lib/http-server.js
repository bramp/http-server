 ...
 * specified `options`.
 *
 * @param {Object} options Options used to construct the HttpServer.
 * @returns {HttpServer} A new instance of HttpServer.
 */
...
function HttpServer(options) {
  ...
  if (typeof options.cache === 'undefined') {
    ...
    this.cache = 'no-cache, no-store, must-revalidate';
  }
  else {
    this.cache = options.cache; // in seconds.
  }
